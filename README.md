...
The workflows cache both npm dependencies and Playwright browser binaries so repeat runs spend less time reinstalling the same toolchain.
...
- **Process:**
  ...
  8. Creates and polls the GitHub Pages deployment through the Pages API using `actions/github-script@v8`
