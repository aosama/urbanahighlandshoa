...
## Project Context
- Astro 6.x with Islands Architecture and the Content Layer API
...
- Configure `tsconfig.json` with current Astro-compatible settings:
```json
{
...
- Enable with `<ClientRouter />` component in the layout head
